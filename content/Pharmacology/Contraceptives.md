...
###### Mechanism of action
Action is functionally the same as [[#Combined oral contraceptive (COCs)|combined oral contraceptives]].
...
Otherwise similar to [[#Combined oral contraceptive (COCs)|COCs]].
###### Adverse effects
Similar to [[#Combined oral contraceptive (COCs)|COCs]].
###### Contraindications
Similar to [[#Combined oral contraceptive (COCs)|COCs]].
###### Examples
...
###### Mechanism of action
Action is functionally the same as [[#Combined oral contraceptive (COCs)|combined oral contraceptives]]. The hormones are absorbed through the vaginal epithelium and enters systemic circulation.
...
###### Mechanism of action
Functions similarly to [[#Progesterone-only pill (POPs)|progestin-only contraceptive pills]] except progesterone administered via injection of depot medroxyprogesterone acetate (DMPA).
...
Other concerns include potential decreased bone mineral density but otherwise similar to [[#Progesterone-only pill (POPs)|POPs]].
###### Contraindications
Similar to [[#Progesterone-only pill (POPs)|POPs]].
###### Examples
...
Failure rate: ~0.6%
###### Initiation
Similar to [[#Hormonal IUD|hormonal IUDs]].
###### Indications
...
### Progestin Implant
###### Mechanism of action
The implant in the subdermal upper arm contain extended-release of etonogestrel which functions like other [[#Progesterone-only pill (POPs)|progestin-only hormonal contraceptives]].
...
Otherwise similar to [[#Progesterone-only pill (POPs)|POPs]].
###### Adverse effects
Similar to [[#Progesterone-only pill (POPs)|POPs]].
###### Contraindications
Similar to [[#Progesterone-only pill (POPs)|POPs]].
