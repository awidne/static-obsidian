...
creation date: 2025-07-03 15:17 
tags: [[Pathologies]]
...
**Pulmonary features**
Due to the accumulation of WBCs, fluids, and proteins in the alveolar space:
...
Severity of symptoms can be determined by the [Pneumonia Severity Index](https://www.mdcalc.com/calc/33/psi-port-score-pneumonia-severity-index-cap) or the [CURB-65](https://www.mdcalc.com/calc/324/curb-65-score-pneumonia-severity). 
### Risk factors
A number of risk factors increases the risk of pneumonia:
- Older age
- Chronic comorbidities, especially [[Chronic Obstructive Pulmonary Disorder|COPD]], chronic lung disease, chronic heart disease, stroke, diabetes, malnutrition, and immunocompromising conditions
...
- Lobar consolidations
  ![[Community-Acquired Pneumonia-1.png|300]]
- Interstitial infiltrates
  ![[Community-Acquired Pneumonia-2.png|500]]
- Cavitations (gas filled space within lung tissue; abscess/pneumatocele sequelae)
  ![[Community-Acquired Pneumonia-3.png|400]]
...
The primary treatment of pneumonia is antibiotics. They are discussed in more detail [[Antibiotics|separately]].

**Outpatient**
Patient is otherwise healthy with normal vitals (except fever) and no concerns for complications (PSI class I-II (≤70), CURB-65 0 or 1 if ≥65).
...
**Hospital inpatient**
Patient with peripheral O2 sats <92 on room air or those with PSI ≥III (>70) and CURB-65 ≥1 (≥2 for age >65).
...
**Hospital ICU**
Patients with respiratory failure requiring mechanical ventilation, sepsis requiring vasopressor support and/or other criteria of severe illness.
