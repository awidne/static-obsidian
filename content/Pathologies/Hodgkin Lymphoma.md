...
- Stage I: single lymph node regions (I) or of a single extralymphatic organ or site (I<sub>E</sub>) without nodal involvement. A region can include one node or a group of adjacent nodes
- Stage II: involvement of two or more lymph node regions on the same side of the diaphragm alone (II) or involvement of a limited, contiguous extralymphatic organ or tissue (II<sub>E</sub>)
