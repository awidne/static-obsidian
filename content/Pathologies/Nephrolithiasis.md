...
Physical should include abdominal exam and checking the costovertebral angle for tenderness.
### Risk factors
...
- Urinalysis (for hematuria, concurrent UTI, and/or b-hCG)
...
Persistent kidney obstruction can result in permanent kidney damage (recurrent post-renal [[Acute Kidney Injury|AKI]]). Staghorn calculi (large renal pelvic stones that extend into the calyces) can result in kidney failure if bilaterally over time despite being asymptomatic.
